...
### Fixed
- Equipment edits now write to all 7 save blocks so changes persist in-game
...
### Added
- Materials category with 296 items (gems, nihil crafting, heart items, dungeon materials)
- Category tabs in inventory editor to switch between Consumables and Materials

## [1.1.0] - 2026-03-20

### Added
- Consumable item inventory editor with 266 items (healing, battle, incense, food, gifts, books)
- Search and filter controls for inventory items
- "Max All Owned" bulk action for consumable quantities
